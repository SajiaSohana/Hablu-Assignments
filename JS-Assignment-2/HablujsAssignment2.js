...
function celsiusToFahrenheit(celsius) {
  ...
  // Problem 6: Get the first element of an array
  ...
  // Problem 7: Check if an array is empty
  ...
  // Problem 8: Return the factorial of a number
  ...
  // Problem 10: Convert a string to lowercase
  ...
  // Problem 11: Find the length of a string
  ...
  // Problem 13: Get the last element of an array
  ...
  // Problem 14: Get the first character of a string
  ...
  // Problem 15: Find the sum of all elements in an array
